...
from cnnmodel.fcheadnet import FCHeadNet
...
# construct the image generator from integers to vectors
...
# place the head FC model on top of the bse model, the model to be trained
model = Model(inputs=baseModel.input, outputs=headModel)

# loop over all layers in base model and freeze them so they will not be updated during the training process
...
# now that the head FC layers have been trained/initialized, let's unfreeze
# final set of CONV layers and make them trainable
...
# train the model again, this time fine-tuning both the final set of CONV layers along with the new FC layers
